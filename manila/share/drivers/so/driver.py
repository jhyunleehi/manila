...
class SOShareDriver(driver.ShareDriver):
    ...
    def create_share(self, context, share, share_server=None):
        ...
        location = self.so.create_share(context, share, share_server)
    ...
    def create_share_from_snapshot(self, context, share, snapshot,
        ...
        location = self.so.create_share_from_snapshot(
    ...
    def extend_share(self, share, new_size, share_server=None):
        ...
        self.so.extend_share(share, new_size, share_server)

    def shrink_share(self, share, new_size, share_server=None):
        """Is called to shrink share."""
        if self.shrink_share_support:
            self.so.shrink_share(share, new_size, share_server)
        else:
            raise NotImplementedError()

    def create_snapshot(self, context, snapshot, share_server=None):
        """Is called to create snapshot."""
        return self.so.create_snapshot(context, snapshot, share_server)

    def delete_share(self, context, share, share_server=None):
        """Is called to remove share."""
        self.so.delete_share(context, share, share_server)

    def delete_snapshot(self, context, snapshot, share_server=None):
        """Is called to remove snapshot."""
        self.so.delete_snapshot(context, snapshot, share_server)

    def ensure_share(self, context, share, share_server=None):
        """Invoked to sure that share is exported."""
        self.so.ensure_share(context, share, share_server)

    def allow_access(self, context, share, access, share_server=None):
        """Allow access to the share."""
        self.so.allow_access(context, share, access, share_server)

    def deny_access(self, context, share, access, share_server=None):
        """Deny access to the share."""
        self.so.deny_access(context, share, access, share_server)

    def update_access(self, context, share, access_rules, add_rules,
                      delete_rules, share_server=None):
        """Update access to the share."""
        return self.so.update_access(context, share, access_rules,
                                         add_rules, delete_rules, share_server)

    def check_for_setup_error(self):
        """Check for setup error."""
        self.so.check_for_setup_error()

    def do_setup(self, context):
        """Any initialization the share driver does while starting."""
        self.so.connect(self, context)
    ...
    def _update_share_stats(self):
        ...
        self.so.update_share_stats(data)
        super(SOShareDriver, self)._update_share_stats(data)
        LOG.info(f"Updated share stats: {self._stats}")

    def get_network_allocations_number(self):
        """Returns number of network allocations for creating VIFs."""
        return self.so.get_network_allocations_number()
    ...
    def _setup_server(self, network_info, metadata=None):
        ...
        return self.so.setup_server(network_info, metadata)

    def _teardown_server(self, server_details, security_services=None):
        """Teardown share server."""
        return self.so.teardown_server(server_details, security_services)
    ...
    def revert_to_snapshot(self, context, snapshot, share_access_rules,
        ...
        if self.revert_to_snap_support:
            return self.so.revert_to_snapshot(context, snapshot,
                                                  share_access_rules,
